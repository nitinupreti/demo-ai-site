...
- **Reuse before create** (see Step 1.5). Tier order: (1) reuse project component as-is; (2) extend project component via `sling:resourceSuperType`; (3) extend Core Component; (4) create new. Duplicating a component is a defect. Same fields + different look → variant select, NOT sibling component. Extension naming: `<parent>-<qualifier>`.
